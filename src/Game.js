...
export class Game {
  ...
  initSprites() {
    ...
    this.sprites.loadTexture('enemy', 'res/gemini enemy_cleaned.png');
    this.sprites.loadTexture('boss', 'res/gemini boss_cleaned.png');
    [COLORS.invader1, COLORS.invader2, COLORS.invader3].forEach(color => {
