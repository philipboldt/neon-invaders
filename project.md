...
## Recent Changes
- **MCP Server Fix:** Resolved the "Connection closed" error during discovery by updating the Playwright MCP server configuration to use the correct package name, `@playwright/mcp`. This ensures proper communication between the Gemini CLI and the browser automation tools. **[NEW]**
